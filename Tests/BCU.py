        ...
        def check_charging(self):
            def check_charging_contactors():
                ...
                if self.d_sup.get_pin_state() == 1:
                    return False
                return True
            assertions.check(check_charging_contactors, msg="Contactors are not closed while in charging state")
        ...
        def check_open(self):
            def check_open_contactors():
                ...
                if self.d_sup.get_pin_state() == 0:
                    return False
                return True
            assertions.check(check_open_contactors, msg="Contactors are not open while in open state")
        ...
        def check_close(self):
            def check_close_contactors():
                ...
                if self.d_sup.get_pin_state() == 1:
                    return False
                return True
            assertions.check(check_close_contactors,msg="Contactors are not closed while in close state")
